...
//     }
//     try {
//       const res = await axiosInstance.post(`${API_BASE_URL}/api/user/send-otp`, {
...
//     setVerifying(true);
//     try {
//       const res = await axiosInstance.post(`${API_BASE_URL}/api/user/verify-otp`, {
...
//     setLoading(true);
//     try {
//       const res = await axiosInstance.get(`${API_BASE_URL}/api/user/buyers`);
//       setAgents(res.data);
//       setLoading(false);
//     } catch (error) {
...
//       try {
//         if (editMode) {
//           await axiosInstance.put(`${API_BASE_URL}/api/user/${editId}`, data, {
...
//     try {
//       await axiosInstance.delete(`${API_BASE_URL}/api/user/${id}`);
...
function Agents() {
  ...
  const fetchAgents = async () => {
    setLoading(true);
    try {
      const res = await axiosInstance.get(`${API_BASE_URL}/api/user/pagination/buyers`, {
        params: {
          page: currentPage,
          limit: itemsPerPage,
          search: searchTerm,
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  >
                    <input
                      ...
                      onFocus={(e) => {
                        e.target.style.borderColor = "#2E6F6E";
                        e.target.style.boxShadow =
                          "0 2px 12px rgba(46, 111, 110, 0.2)";
